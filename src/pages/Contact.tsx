      ...
      <div className="container mx-auto px-4 sm:px-8 lg:px-16 xl:px-20 2xl:px-24 py-20">
        <div className="bg-white grid grid-cols-1 md:grid-cols-2 items-center gap-10 p-6 lg:p-10 rounded-md">
          <div className="flex flex-col">
            ...
            <input type="text" id="f-name" className="bg-gray-50 border border-gray-200 p-3 rounded-md" placeholder="Enter your first name" />
          </div>
          <div className="flex flex-col">
            <label htmlFor="l-name" className="font-semibold mb-2">Last Name</label>
            <input type="text" id="l-name" className="bg-gray-50 border border-gray-200 p-3 rounded-md" placeholder="Enter your last name" />
          </div>
          <div className="md:col-span-2 flex flex-col">
            <label htmlFor="subject" className="font-semibold mb-2">Subject</label>
            <input type="text" id="subject" className="bg-gray-50 border border-gray-200 p-3 rounded-md" placeholder="Enter your subject" />
          </div>
          <div className="md:col-span-2 flex flex-col">
            <label htmlFor="message" className="font-semibold mb-2">Message</label>
            <textarea rows={5} id="message" className="bg-gray-50 border border-gray-200 p-3 rounded-md resize-none" placeholder="Enter your message" />
          </div>
