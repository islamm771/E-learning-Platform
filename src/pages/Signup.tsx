          ...
          <div className="bg-white p-6 rounded-md">
            ...
            <form action="" className="space-y-4">
              <div className="flex flex-col">
                <label htmlFor="" className="font-semibold mb-2">Full Name</label>
                <input type="text" className="bg-gray-50 border border-gray-200 p-3 rounded-md" placeholder="Enter your email" />
              </div>
              <div className="flex flex-col">
              ...
              <Button className="block w-full text-center">Sign Up</Button>
            </form>
